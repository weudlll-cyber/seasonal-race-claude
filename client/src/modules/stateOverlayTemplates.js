...
export const OVERLAY_TEMPLATES = {
  OVERVIEW: [
    'Aktuell führt {leader}',
    '{leader} an der Spitze',
    'Position 1: {leader}',
    'Vorne dabei: {leader}',
    '{leader} macht das Tempo',
    'Das Feld folgt {leader}',
    '{leader} hält die Führung',
    'Noch führt {leader}',
  ],
  BATTLE_ZOOM: [
    'Kampf um Platz {position} mit {count} Fahrern',
    '{count} Racer kämpfen um Position {position}',
    'Heißer Pulk auf Platz {position}',
    'Wer schnappt sich Platz {position}? — {count} Anwärter',
    'Eng beieinander auf Position {position}',
    'Dicht gedrängt: {count} auf Platz {position}',
    'Kein Durchkommen — Pulk auf Platz {position}',
    'Spannend: {count} Racer auf Platz {position}',
  ],
  COMEBACK_ZOOM: [
    'Comeback! {racer} holt auf',
    '{racer} kämpft sich nach vorne',
    'Aufholjagd von {racer}',
    '{racer} arbeitet sich durchs Feld',
    '{racer} gibt nicht auf',
    'Zurück im Rennen: {racer}',
    '{racer} drängt nach oben',
    'Stark: {racer} holt Meter für Meter',
  ],
};
