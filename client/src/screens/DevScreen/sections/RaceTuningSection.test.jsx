...
describe('RaceTuningSection — renders all 8 blocks', () => {
  ...
  it('renders the finale front-compression toggle + gate fields (Act 2 eye-test control)', () => {
    ...
    // Act 2 adaptive controls (spread-scaled gates) sit in the same sub-heading group.
    expect(screen.getByTestId('finale-adaptive-gates-toggle')).toBeTruthy();
    expect(screen.getByLabelText('Catch-up gate fraction c')).toBeTruthy();
    expect(screen.getByLabelText('Leader-bleed gate fraction b')).toBeTruthy();
  });
