...
// Project:     RaceArena
// Created:     2026-05-04
// Description: Consolidated Race Tuning section — 6 blocks in storyline order:
//              Speed Range, Start Layout, Row Start, Speed Re-Roll,
//              Drafting, Speed Brake.
//              Combines content from former BaseSpeedSection + RaceBehaviorSection
//              + new raceDynamicsConfig (PR-A2.6 re-roll values).
//              Force-based avoidance blocks (Comfort Zone, Soft Avoidance, Home Force)
//              removed — replaced by slot-based anti-collision (no UI sliders needed).
// ============================================================
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <SubCard
        ...
        subtitle="When no free slot is available, the yielding racer slows down to avoid rear-ending the racer ahead. This controls how much they slow down."
        disabled={!behaviorConfig.enabled}
      >
        <div className={s.formGrid}>
          <div className={s.formGroup}>
      ...
      <div className={s.card}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          >
            ...
            <InfoTooltip text="When off, racers run independently with no avoidance or drafting. physicalY stays at 0 (centerline). Blocks 5–6 above are disabled when this is off." />
          </label>
        </div>
      </div>
    </div>
