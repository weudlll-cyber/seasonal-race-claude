...
| count | value |
| ---------------------------------------------------------------------------------------------- | ----- |
| files in the RACE HULL — `node scripts/engine-reach.mjs` | 193 |
...
| hull files the folder rule never covered — listed in [SIM.md](SIM.md), not here | 101 |
...
**Costs below are GENERATED, never typed** — measured on commit `04f40f17`, 2026-09-11 04:44 UTC, on `Testrechner`,
...
| guard | cost |
|---|---|
| `scripts/fingerprint-default.mjs` — **world** | 49 s |
| `scripts/camera-fingerprint.mjs` — **camera** | 41 s |
| `scripts/render-fingerprint.mjs` — **render** | 23 s |
