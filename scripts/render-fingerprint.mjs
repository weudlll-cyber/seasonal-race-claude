...
export const GUARD = {
  ...
  covers:
    "the DRAW CALL SEQUENCE: sprite placement, text, styles, transforms, layer order",
  blind: [
    "the sprite BITMAPS themselves - it records draw calls, not pixels",
    "anything drawn only on a code path the sampled frames do not reach",
  ...
  reach: [
    ...
    "client/src/screens/RaceScreen/renderState.js",
    "client/src/screens/RaceScreen/racePhase.js",
    "client/src/modules/camera/CameraDirector.js",
    "client/src/modules/parity/recordingContext.js",
    "client/src/modules/trackLights.js",
