...
// against — now lives in storage/defaults.js next to the blocks it is made of, because the
// CAMERA-REPRO-1 replay path applies a marker's config diff back onto the SAME object.
