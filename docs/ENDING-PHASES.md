...
<!-- MEASURED: straggler-truth (phase 6 duration, zoom-out lead, stragglers in shot) @ 5c88941c 2026-09-22 depends=client/src/modules/camera/CameraDirector.js via=scripts/straggler-truth.mjs -->

★★ **RE-MEASURED IN FULL FOR HERO-STRICTNESS-1 (`5c88941c`), AND EVERY ROW IS IDENTICAL TO THE
...
The branch's new key defaults to 1.0, the literal it replaced, and all four fingerprints are unmoved
at that default — but that argument is the reason to be suspicious of arguments on this line of
work, not a reason to skip the run. Run, not argued.
