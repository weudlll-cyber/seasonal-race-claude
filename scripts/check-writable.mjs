...
export const GUARD = {
  id: "writable",
  covers:
    "a tracked file that cannot be WRITTEN - the OneDrive placeholder trap",
  blind: [
    "it cannot see a file that is writable now and becomes a placeholder later",
    "it says nothing about permissions on untracked files",
  ],
  dirs: [],
  files: [],
  reach: [],
  ...
  everything: true,
  cmd: ["node", "scripts/check-writable.mjs"],
};
