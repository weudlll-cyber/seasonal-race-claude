...
| `logoCorner`     | string       | In-race logo position. Supported values: `'bottom-right'` (default), `'top-right'`. The renderer selects from a lookup map with `'bottom-right'` as fallback ([`BrandLogoOverlay.jsx` → `CORNER_STYLES`](../client/src/screens/RaceScreen/BrandLogoOverlay.jsx#L16-L30)). Position is **data-driven, not hardcoded**. What is missing is a UI control in BrandingProfiles to set it; see §4. |
...
| ------------------------- | --------------------------------------------------------------------------------------- | ----------------------------------- | ------------------------- |
| `racearena:branding`      | `KEYS.BRANDING` ([`storage.js` → `LAST_USER`](../client/src/modules/storage/storage.js#L13))       | `[]`                                | Array of profile objects  |
| `racearena:activeSession` | `KEYS.ACTIVE_SESSION` ([`storage.js` → `ACTIVE_SESSION`](../client/src/modules/storage/storage.js#L14)) | `{ activeBrandingProfileId: null }` | Active profile id or null |
...
4. **Race canvas title overlay**: `RaceScreen` loads `raceData` from `sessionStorage.activeRace`
   ([`index.jsx` → `lcData`](../client/src/screens/RaceScreen/index.jsx#L356-L358))
   and passes it to:
...
5. **ResultScreen brand block** (direct storage read, not via carrier): `ResultScreen` calls
   ...
   ([`ResultScreen/index.jsx:98`](../client/src/screens/ResultScreen/index.jsx#L98))
   and renders ([`index.jsx` → `raceSeed`](../client/src/screens/ResultScreen/index.jsx#L237-L262)):
...
- **Brand identity block** (conditional on active profile): event name in `primaryColor`, subtitle in
  ...
  ([`index.jsx` → `raceSeed`](../client/src/screens/ResultScreen/index.jsx#L237-L262)).
...
- **Podium** (ranks 1–3): animated slots with racer icon, name, and finish time
  ([`index.jsx` → `Action`](../client/src/screens/ResultScreen/index.jsx#L276-L321)).
