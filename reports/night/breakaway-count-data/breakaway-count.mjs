// ============================================================
// File:        breakaway-count.mjs
// Path:        reports/night/breakaway-count-data/breakaway-count.mjs
// Project:     RaceArena — BREAKAWAY-COUNT-1
// Description: A COUNT, at the OWNER'S threshold, in today's shipped world. How often a breakaway
//              happens inside the last 30% of the race, how long it lasts, whether it is ever reeled
//              in, and who is in front when it happens.
//
...
const RACERS = 40;
const SECONDS = 60;
const WORLD = RD.worldForActionStage("quiet"); // the shipped stage, defaults.js:47
...
writeFileSync(join(OUT, name), JSON.stringify({
  ...
  stage: "quiet", racers: RACERS, seeds: SEEDS, rows,
}));
