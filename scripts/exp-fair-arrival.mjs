...
// Owner's arms + the R lever (the R=0.80 SPEC B plateaus below the gate; earlier-R shows the trade).
const ARMS = {
  ship: [],
  A: ['--chaosAnchor=true', '--chaosAnchorGain=0.06'],
  Bweak: ['--bandBias=true', '--bandR=0.80', '--bandBiasGain=0.03'],
  Bmed: ['--bandBias=true', '--bandR=0.80', '--bandBiasGain=0.06'],
  B60: ['--bandBias=true', '--bandR=0.60', '--bandBiasGain=0.10'],
  AB60: ['--chaosAnchor=true', '--chaosAnchorGain=0.06', '--bandBias=true', '--bandR=0.60', '--bandBiasGain=0.10'],
  C: ['--bandWall=true', '--bandR=0.80', '--bandWallGain=4'],
};
