...
<!-- HISTORICAL: 2026-05-16 — read-only camera inventory taken at commit 5088639, before the corridor zoom unit -->

> **Read this as HISTORY.** It records what was measured or true on 2026-05-16. Config values in it are
...
```javascript
const cam = camDirRef.current.update(
  st.racers,
  ts,
  raceState,
  CANVAS_W,
