...
| `reports/night/hero-strictness-data/hero-strictness-sweep.mjs` | Five values of `choreoHeroStrictness` on the fixture BREAKAWAY-COUNT-2 used, so the control is comparable to its 16.0% and to GROUP-BRAKE-SWEEP-1's control, which reproduced tha… |
