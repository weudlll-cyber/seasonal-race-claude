...
export const TRACK_PATHS = {
  ...
  's-curve': {
    ...
    closed: false,
    backgroundImage: '/assets/tracks/backgrounds/space-sprint.jpg',
  },
  spiral: {
    ...
    closed: false,
    backgroundImage: '/assets/tracks/backgrounds/river-run.png',
  },
  zigzag: {
    ...
    closed: true,
    centerFrac: { x: 0.5, y: 0.5 },
    backgroundImage: '/assets/tracks/backgrounds/garden-path.png',
  },
  rectangle: {
