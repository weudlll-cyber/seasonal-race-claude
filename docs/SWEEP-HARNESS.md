...
**Owns:** the permanent measurement stack around the sim — observers, the orchestrator pattern for a new sweep, the determinism rule, output conventions. How to RUN the simulator is [SIM.md](SIM.md)'s.
